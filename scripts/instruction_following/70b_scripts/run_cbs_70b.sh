...
output_dir="output/instruction_following/70b/cbs/w4k4l16"
...
python scripts/instruction_following/utils/merge_data.py \
    --base_path output/instruction_following/70b/cbs/w4k4l16 \
    --output_dir output/instruction_following/70b/cbs/w4k4l16/merge_data.json \
...
alpaca_eval --model_outputs output/instruction_following/70b/cbs/w4k4l16/train_merge_reward.json  \
    --output_path output/instruction_following/70b/cbs/w4k4l16 \
