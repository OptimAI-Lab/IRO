...
scorer_name=output/instruction_following/70b/gen_iter1/value_model

reward_model_path=SiliangZ/RM_Mistral_sft_init_ultrafeedbck_lr_5e6
defined_name=8196_epoch10_ultrafeedbck_lr_5e6_mse_70b_iter1

generator="${defined_name}_w${w}_k${k}_l${l}_0.6_0.9_${reward_model_path}_${frac_len}"


save_dir="output/instruction_following/70b/value_guiding/fullset/${defined_name}_w${w}_k${k}_l${l}_0.6_0.9_${reward_model_path}_${frac_len}_epoch10/decoding_${decoding_strategy}"


conda activate decoding

CUDA_VISIBLE_DEVICES=0,1,2,3 PYTHONPATH=. python scripts/instruction_following/generate_iro.py \
...
CUDA_VISIBLE_DEVICES=4,5,6,7 PYTHONPATH=. python scripts/instruction_following/generate_iro.py \
