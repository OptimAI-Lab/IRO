...
save_dir="output/instruction_following/70b/value_guiding/fullset/${defined_name}_w${w}_k${k}_l${l}_0.6_0.9_${reward_model_path}_${frac_len}_${beta1}_${beta2}/decoding_${decoding_strategy}"
...
CUDA_VISIBLE_DEVICES=0,1,2,3 PYTHONPATH=. python scripts/instruction_following/generate_iro.py \
    ...
    --output_dir=${save_dir} --batch_size 4 --frac_len ${frac_len} &
