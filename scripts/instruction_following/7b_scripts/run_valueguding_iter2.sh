...
save_dir="output/instruction_following/8b/value_guiding/fullset/${defined_name}_w${w}_k${k}_l${l}_0.6_0.9_${reward_model_path}_${frac_len}_${beta1}_${beta2}/decoding_${decoding_strategy}"
