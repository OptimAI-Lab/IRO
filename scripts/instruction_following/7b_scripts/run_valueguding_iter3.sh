...
scorer_name2=output/instruction_following/8b/rollout_iter1/gen_2_8192/value_model
scorer_name3=output/instruction_following/8b/rollout_iter2/gen_3_8192/value_model

reward_model_path=SiliangZ/RM_Mistral_sft_init_ultrafeedbck_lr_5e6

defined_name=8196_epoch10_ultrafeedbck_lr_5e6_mse_8b_iter3
...
save_dir="output/instruction_following/8b/value_guiding/fullset/${defined_name}_w${w}_k${k}_l${l}_0.6_0.9_${reward_model_path}_${frac_len}_${beta1}_${beta2}_${beta3}/decoding_${decoding_strategy}"
...
#     --ref_data_path output/instruction_following/8b/bon/n16_0.6_0.9/train_merge_reward_eval.json \
