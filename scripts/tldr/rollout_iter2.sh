...
data_frac=3
frac_len=8192
save_dir="output/tldr/1b_1b/rollout_iter2/gen_${data_frac}_${frac_len}"
# save_dir="output/tldr/1b_6.9b/rollout_iter2/gen_${data_frac}_${frac_len}"

base_model=vwxyzjn/EleutherAI_pythia-1b-deduped__sft__tldr
# base_model=vwxyzjn/EleutherAI_pythia-6.9b-deduped__sft__tldr


score_model1=output/tldr/1b_1b/rollout_iter0/gen_1_8192/value_model_8k_b256
score_model2=output/tldr/1b_1b/rollout_iter1/gen_2_8192/value_model_8k_b256
# score_model1=output/tldr/1b_6.9b/rollout_iter0/gen_1_8192/value_model_8k_b256
# score_model2=output/tldr/1b_6.9b/rollout_iter1/gen_2_8192/value_model_8k_b256
