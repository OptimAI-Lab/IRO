...
score_model3=output/tldr/1b_1b/rollout_iter2/gen_3_8192/value_model_8k
...
# score_model3=output/tldr/1b_6.9b/rollout_iter2/gen_3_8192/value_model_8k

data_frac=1
frac_len=300

save_dir="output/tldr/1b_1b/cbs_modified_log/iter3_${w}_${k}_${l}_${beta1}_${beta2}_${beta3}"
# save_dir="output/tldr/1b_6.9b/cbs_modified_log/iter3_${w}_${k}_${l}_${beta1}_${beta2}_${beta3}"
